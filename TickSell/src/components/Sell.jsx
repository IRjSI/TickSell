...
function Buy() {
  return (
    <div className='mt-24 flex flex-col justify-center items-center'>
        <div className='flex flex-row bg-slate-700 rounded-lg p-2 mb-6'>
        ...
        <form className='flex flex-col gap-4'>
            ...
            <input type="text" id='PNR' placeholder='PNR' className={`p-2 w-full rounded-md outline-none bg-slate-600 text-white`}/>
